...
$requete = $bdd -> prepare('INSERT INTO historique_message(heure, text_message, id_utilisateur, id_chat) VALUES (now(),:text_message,:id_utilisateur,3)');
$requete -> execute(array('text_message' => $_POST['message'], 'id_utilisateur' => $_SESSION['id_utilisateur']));
}
$reponse = $bdd->query('SELECT * FROM historique_message INNER JOIN utilisateur ON historique_message.id_utilisateur = utilisateur.id_utilisateur WHERE id_chat= "3"');
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Tchat/C3PO</title>
        <link rel="stylesheet" type="text/css" href="../../../public/css/chat/light/chat_c3po.css">
    </head>
    <div id="laPage">
        <style>
        form
        ...
        <h1>Chat C3PO</h1>
          <p class="message_profil">Nous sommes perdu <?php echo $_SESSION['pseudo'];?>
        <hr>
      </header>
            <h1></h1>
                <form action="" method="post">
                    <fieldset>
                        ...
                        echo '<div align="center">';
                            echo '<div style="color: black; text-shadow: 2px 2px 2px 	#FFD700;">';
                ...
                <br>
                <div align="center">
                <a class="imgReturn" href="http://localhost:8888/SVE%20MC/Star_chat/light/chat_of_light.php"><img src="../../content/img/corBack.png" height=170px; alt= "Back" name="Return"></a>
                </div>
